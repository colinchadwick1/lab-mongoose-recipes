...
const fillWithRecipe = async () => {
  try {
    ...
    const deleteList = await Recipe.deleteMany();
    ...
    console.log("Iteration 1", newRecipe);
    ...
    const newRecipe2 = await Recipe.insertMany(recipes);
    console.log("Iteration 2", newRecipe2);

    //ITERATION 3 
    const updatedRecipe = await Recipe.findOneAndUpdate({title: "Rigatoni alla Genovese"}, {duration: 100});
    console.log("Iteration 3", "successfully updated");
